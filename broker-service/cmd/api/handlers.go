...
func (app *Config) HandleSubmission(w http.ResponseWriter, r *http.Request) {
	...
	case "log":
		// app.logItem(w, requestPayload.Log) // log event without rabbit mq
...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	// create a json we will send it to auth microservice
...
func (app *Config) sendMail(w http.ResponseWriter, msg MailPayload) {
	...
	request, err := http.NewRequest(http.MethodPost, mailerServiceURL, bytes.NewBuffer(jsonData))
	if err != nil {
		app.errorJSON(w, err)
		return
	}
	...
	var payload JsonResponse
	payload.Error = false
	payload.Message = "Mailed to " + msg.To
